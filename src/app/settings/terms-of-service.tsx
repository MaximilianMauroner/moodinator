      ...
      >
        ...
        <View className="my-4 p-4 rounded-2xl bg-coral-100 dark:bg-coral-900">
          ...
          <Text className="text-sm text-coral-700 dark:text-coral-400 leading-5 font-medium">
            Moodinator does not monitor entries, provide live crisis support, contact emergency services, or dispatch help. For ratings 9 and 10, it displays a dismissible reminder that must be closed before continuing the entry. If someone may be in immediate danger, call the local emergency number. You may also want to contact a local crisis helpline. Moodinator does not initiate either action.
          </Text>
        </View>
